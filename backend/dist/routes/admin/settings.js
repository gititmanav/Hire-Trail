...
router.put("/", validate(systemSettingSchema), async (req, res, next) => {
    try {
        ...
        const setting = await SystemSettings.findOneAndUpdate({ key }, { $set: update }, { new: true, upsert: true });
