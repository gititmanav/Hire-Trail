...
router.get("/", async (_req, res, next) => {
    try {
        ...
        const [totalUsers, totalApplications, totalResumes, totalContacts, totalDeadlines, signupsToday, signupsThisWeek, signupsThisMonth, activeUserLogins, recentActivity, userGrowth, appsPerDay,] = await Promise.all([
