 ...
 *  Google leads because Gemini Flash has a generous free tier (15 RPM / 1M tokens/day on the free
 *  plan), keeping default-user inference free for us. Anthropic/OpenAI take over only if a Google
 *  key isn't set, and BYOK users override this entirely. */
