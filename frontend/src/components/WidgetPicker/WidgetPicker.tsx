...
export default function WidgetPicker({ visible, onToggle, onReset, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/45 flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-[480px] shadow-2xl animate-in" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Toggle widgets to show or hide them on your dashboard.</p>
