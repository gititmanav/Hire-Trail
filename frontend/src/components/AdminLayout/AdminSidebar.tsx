...
const adminNav = [
  ...
  { to: "/admin/calendar", label: "Calendar", d: "M8 2v3M16 2v3M3 9h18M5 5h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z" },
  ...
  { to: "/admin/broadcasts", label: "Broadcasts", d: "M3 11l18-8-4 18-6-6-8-4zm8 6l3-7" },
