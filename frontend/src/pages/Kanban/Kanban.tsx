...
const GhostKanbanCard = memo(function GhostKanbanCard({ app, fromStage }: { app: Application; fromStage: Stage }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 min-w-0">
        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" aria-hidden className="text-muted-foreground shrink-0">
          <path d="M9 5l7 7-7 7" />
        </svg>
    ...
    <div className="fade-up">
      ...
      {showStuckSuggestion && (
        <div className="mb-4 rounded-xl border border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/20 px-4 py-3 flex items-center justify-between gap-3 flex-wrap">
          <div className="flex items-center gap-2 min-w-0">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-amber-700 dark:text-amber-300 shrink-0" aria-hidden>
