...
export default function FounderScene() {
  ...
  return (
    <section ref={sectionRef} className="lp-founder relative" aria-label="Why HireTrail exists">
      ...
      <div ref={stageRef} className="sticky top-0 h-screen h-svh overflow-hidden bg-[hsl(var(--lp-night))]">
        ...
        <div className="relative h-full max-w-[1080px] mx-auto px-6 flex flex-col justify-center lp-on-light">
          ...
          <div ref={signRef} className="mt-10 flex items-center gap-4" style={{ opacity: 0 }}>
            ...
            <Link to="/about" className="lp-link ml-auto text-[15px] text-[hsl(var(--lp-ink))]">
