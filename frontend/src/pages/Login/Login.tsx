...
export default function Login({ onLogin }: { onLogin: (u: User) => void }) {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left — branding panel with light background */}
      <div className="hidden lg:flex flex-col justify-center items-center flex-1 bg-[#f0f7fb] relative overflow-hidden px-12 py-16">
        ...
        <div className="max-w-md relative z-10">
          {/* Logo + wordmark — sans stack + accent from palette */}
          ...
          <div style={{ animation: "fadeSlideUp 0.5s ease-out 0.7s both" }}>
            ...
            <div className="flex items-center gap-5 opacity-40 grayscale">
              {/* Text-based university names as placeholder logos */}
      ...
      <div className="flex-1 flex items-center justify-center bg-white dark:bg-gray-900 px-6 py-12">
        <div className="w-full max-w-[400px]" style={{ animation: "fadeSlideUp 0.5s ease-out" }}>
          ...
          <div className="flex items-center gap-3 my-6 text-xs">
            <div className="flex-1 h-px bg-gray-200 dark:bg-gray-700" /><span className="text-gray-400">Or sign in with email</span><div className="flex-1 h-px bg-gray-200 dark:bg-gray-700" />
          </div>
